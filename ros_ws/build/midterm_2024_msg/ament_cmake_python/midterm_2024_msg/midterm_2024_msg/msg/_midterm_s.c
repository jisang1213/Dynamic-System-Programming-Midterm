...
bool midterm_2024_msg__msg__midterm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("midterm_2024_msg.msg._midterm.Midterm", full_classname_dest, 37) == 0);
  }
  midterm_2024_msg__msg__Midterm * ros_message = _ros_message;
  {  // angular_velocity
...
{
  /* NOTE(esteve): Call constructor of Midterm */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("midterm_2024_msg.msg._midterm");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Midterm");
